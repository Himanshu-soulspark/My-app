...
// ===================================================================
// === ज़रूरी बदलाव 1: यहाँ अपनी ₹10,000 वाली Live Plan ID डालें ===
const MAIN_PLAN_ID = 'plan_RcS3moW6ej8y8g'; // सिर्फ आपकी ₹10,000 वाली Live Plan ID
// ===================================================================
...
// ============================================================================
// ============================================================================
// === मूवी लिंक पाने के लिए API एंडपॉइंट ===
...
app.post('/create-subscription', async (req, res) => {
    try {
        ...
        // === ज़रूरी बदलाव 2: सब्सक्रिप्शन शुरू होने का समय 30 मिनट (1800 सेकंड) बाद सेट किया गया है ===
        const startTimeInFuture = Math.floor(Date.now() / 1000) + 1800; // 1800 सेकंड = 30 मिनट

        console.log(`LIVE: Creating a ₹10,000 subscription for customer ${customer.id} with a ₹5 activation fee...`);
