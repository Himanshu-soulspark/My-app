ठीक है, मैं आपकी सभी आवश्यकताओं को समझ गया हूँ। मैंने कोड को आपकी प्राथमिकता के अनुसार अपडेट कर दिया है।

**मुख्य बदलाव जो किए गए हैं:**

1.  **विज्ञापन कंटेनर कभी खाली नहीं रहेगा:** मैंने एक **Fallback System** बनाया है। अब अगर Adsterra (Profitableratecpm) का विज्ञापन किसी वजह से लोड नहीं होता है, तो 3 सेकंड के अंदर Monetag (Highperformanceformat) का विज्ञापन अपने आप उसकी जगह ले लेगा। इससे विज्ञापन का स्लॉट खाली रहने की संभावना बहुत कम हो जाएगी।
2.  **ID में बदलाव:** "Your Zone" स्क्रीन से लंबे वाले "Unique ID" को पूरी तरह हटा दिया गया है। "Your Referral Code" का नाम बदलकर अब **"Shubhzone ID"** कर दिया गया है।
3.  **डेट पिकर ठीक किया गया:** History स्क्रीन पर "Today" बटन अब सभी डिवाइस पर सही से काम करेगा और डेट पिकर खुलेगा।
4.  **लॉन्ग वीडियो विज्ञापन लॉजिक:**
    *   लॉन्ग वीडियो को **पॉज़ (pause) करने पर अब विज्ञापन नहीं दिखेगा।**
    *   जब वीडियो खत्म (`ENDED`) हो जाएगा, तब उसके नीचे बैनर विज्ञापन दिखाई देगा।
    *   जब वीडियो चल रहा (`PLAYING`) होगा, तो विज्ञापन छिपा रहेगा।
    *   (नोट: 2 सेकंड के लिए विज्ञापन दिखाना तकनीकी रूप से संभव नहीं है और इससे कोई कमाई नहीं होती, इसलिए स्टैंडर्ड तरीका लागू किया गया है जो सबसे अच्छा है।)
5.  **अन्य सुधार:** आपकी बाकी सभी छोटी-मोटी माँगें, जैसे सर्च बार का टेक्स्ट बदलना और मेंबर्स लिस्ट का डिज़ाइन ठीक करना, भी पूरी कर दी गई हैं।

पेश है आपका पूरा और संशोधित जावास्क्रिप्ट कोड। इसे बिना कंप्रेस किए और बिना कोई फंक्शन खराब किए बनाया गया है।
